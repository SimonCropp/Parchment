...
6. Emits the full diagnostic set (`PARCH001`–`PARCH008`, `PARCH010`) and a generated `RegisterWith(TemplateStore store, string? basePath = null)` that calls `store.RegisterDocxTemplate<TModel>(name, path)`.
